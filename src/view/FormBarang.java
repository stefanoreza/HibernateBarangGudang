...
public class FormBarang extends javax.swing.JFrame {
    ...
    public FormBarang() {
        ...
        // Set judul window
        setTitle("CRUD Inventaris Gudang - Hibernate");
        
        // Disable txtId (karena auto increment)
        txtId.setEnabled(false);
        
        System.out.println("Form CRUD Barang siap digunakan!\n");
    }
...
//        txtJurusan.requestFocus();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("FORM INVENTARIS GUDANG");
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            mhs.setJumlah(txtJumlah.getText().trim());
    ...
    private void tblMahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMahasiswaMouseClicked
        ...
        if (row != -1) {
            ...
            txtJumlah.setText(model.getValueAt(row, 1).toString());
